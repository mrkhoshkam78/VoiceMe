...
export const VOCAL_PRESETS = {
  girl: {
    pitchRatio: 1.18,       // ~ +2.9 st – clearly brighter / younger
    formantShift: 0.45,
    highShelf: 3.2,
    presence: 3.5,
    body: -1.5,
  ...
  female: {
    pitchRatio: 1.12,       // ~ +2.0 st – natural adult female, clearly audible
    formantShift: 0.35,
    highShelf: 2.6,
    presence: 3.0,
    body: -0.8,
  ...
  woman: {
    pitchRatio: 1.08,       // ~ +1.3 st – mature warmer female
    formantShift: 0.22,
    highShelf: 1.8,
    presence: 2.2,
    body: 0.4,
  ...
  male: {
    pitchRatio: 0.90,       // ~ -1.8 st – clearly deeper male
    formantShift: -0.32,
    highShelf: -1.5,
    presence: -0.5,
    body: 2.2,
